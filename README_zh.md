...
| [banini-tracker](banini-tracker/) | 追蹤台灣最強反指標女神巴逆逆的 Threads 貼文，讓 Claude 直接做反指標分析。零 API 成本 — Playwright 本地抓資料，Claude 自己就是 LLM。從 [cablate/banini-tracker](https://github.com/cablate/banini-tracker) 改寫而來，省掉每月 $11 的 Apify + LLM API 費用。支援 [skill-cron](skill-cron/) 排程 |
